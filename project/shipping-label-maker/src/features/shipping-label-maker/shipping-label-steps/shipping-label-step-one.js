...
class ShippingLabelMakerStepOne extends Component {
        ...
        return (
          ...
          >
            ...
            >
             ...
             <div
             role="button"
              onClick={() => this.props.onAction(this.state.data, 'from', 2)}
...
export default ShippingLabelMakerStepOne;
